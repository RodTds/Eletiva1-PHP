...
<html lang="en">
  ...
  <body>
    <div class="text-center">   <h1>Desconto Acima de R$100,00</h1></div>
    <div class="row">
  <div class="container d-flex justify-content-center align-items-center col-3 mt-5 mb-3">
     ...
     <form method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="numero" name="valor" class="form-control">
                        </div>
                     ...
                     if($valor > 100)
                      {
                        ...
                        echo"Valor menor que 100,00 -- Não houve desconto";
                      }
